...
url = 'http://75es.com/pic/11/1.html'
...
def getpic(url):
    ...
    for i in girls:
        ...
        path =('%s\\img\\img%s.jpg'%(os.path.split(os.path.realpath(__file__))[0],full_path[(full_path.rfind('/')+3):])) #文件保存路径
...
if __name__ == '__main__':
    ...
    # for p in range(1,5):
    #     p+=1
    #     url='http://75es.com/pic/11/%s.html'%p
    #     #print(url)
    #     getpic(url)
